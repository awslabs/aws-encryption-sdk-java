 ...
 * The AWS KMS symmetric multi-region discovery keyring is an easy way to configure a multi-keyring of AWS KMS region discovery keyrings.
 * <p>
...
public class DiscoveryDecrypt {
    ...
    /**
     * Demonstrate configuring an AWS KMS symmetric multi-region discovery keyring for decryption.
     *
    ...
    public static void run(final AwsKmsCmkId awsKmsCmk, final byte[] sourcePlaintext) {
        ...
        // Create an AWS KMS symmetric multi-region discovery keyring to use on decrypt.
        ...
        final Keyring decryptKeyring = StandardKeyrings.awsKmsSymmetricMultiRegionDiscovery(allRegionIds);
